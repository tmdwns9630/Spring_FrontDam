/*
막대그래프 2개가 들어가는 그래프
damObj이라는 변수로 테스트 데이터 넣어서 했음. 
*/
/*
 * utils.js
 * charts.js 만들기 위한 utils.js 부분
 * 공식 사이트에서 제공하는 utils.js
 이 부분에서 데이터 바뀌는건 차트에 영향 ㅇ벗음
 */
...
waterArr = damObj.map((ele) => {
  return ele.waterLevel/10;
});

lightArr = damObj.map((ele) => {
  return ele.light;
});
